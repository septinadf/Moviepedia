...
import id.sch.smktelkom_mlg.privateassignment.xirpl334.moviepedia.adapter.PopularAdapter;
...
public class Popular extends Fragment {
    ...
    private void downloadDataResource() {
        String url = "https://api.themoviedb.org/3/movie/popular?api_key=8bd1afd99b99d76e2f9d735d99a5128a&language=en-US&page=1";
